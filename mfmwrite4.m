function mfmwrite4(filename,pathname,intscorrect,tform,psfs,intcorrection,process,radius,numplanes,deconviter,zstepsize,d,patternlength,framekeep,suffix,flip)
...
[rawdata,metadata] = readnd22(filename,pathname);
